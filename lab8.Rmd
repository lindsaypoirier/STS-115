...
When comparing certain phenomena across places - particuarly phenomena that are related to human activity - it is often important to consider how population can impact the numbers we see. 
...
Whenever we look at data, we are viewing it at a particular moment in time. However, definitions inevitably change... 
